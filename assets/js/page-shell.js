(() => {
  ...
  const headerMarkup = [
    ...
    '<a class="ibt-shell-mega-lead" href="salla.html"><span>السوق السعودي أولًا</span><strong>خبرة متخصصة في منصات التجارة</strong><p>نحدد ما تسمح به المنصة وما يحتاج تخصيصًا قبل الوعد والتنفيذ.</p></a>',
    ...
    '<a class="ibt-shell-mega-lead" href="tharaa.html"><span>منتج أصلي من ابتكار تك</span><strong>ثيم ثراء لمتاجر سلة</strong><p>منتج مستقل له معاينة ودعم وتوثيق وخدمات تخصيص منفصلة.</p></a>',
    '<a class="ibt-shell-mega-link" href="tharaa.html"><strong>استكشف ثيم ثراء</strong><span>المزايا، تجربة الجوال، صفحة المنتج وخيارات التخصيص.</span></a>',
